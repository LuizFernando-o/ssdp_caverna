...
public class SSDP_CAVERNA {
    public static Pattern[] run(int k, String tipoAvaliacao, double similaridade, double maxTimeSegundos) {
        ...
        // Inicializa garantindo que P maior que Pk sempre! em bases pequenas isso nem
        // sempre ocorre
        ...
        // System.arraycopy(P, 0, Pk, 0, k); //Inicializa Pk com os melhores indivíduos
        // da população inicial
        SELECAO.salvandoRelevantesDPmais(Pk, P, similaridade);

        // System.out.println("P0");
        // System.out.println("Qualidade média k/P: " + Avaliador.avaliarMedia(Pk,k) +
        // "/" + Avaliador.avaliarMedia(P,P.length));
        // System.out.println("Dimensão média k/P: " +
        // Avaliador.avaliarMediaDimensoes(Pk,k) + "/" +
        ...
        for (int numeroReinicializacoes = 0; numeroReinicializacoes < 3; numeroReinicializacoes++) {// Controle número
                                                                                                    // de
                                                                                                    // reinicializações
            ...
            while (numeroGeracoesSemMelhoraPk < 3) {
                ...
                int novosK = SELECAO.salvandoRelevantesDPmais(Pk, PAsterisco, similaridade);// Atualizando Pk e
                                                                                            // coletando número de
                                                                                            // indivíduos substituídos
                ...
                if (novosK > 0 && mutationTax > 0.0) {// Aumenta cruzamento se Pk estiver evoluindo e se mutação não não
                                                      // for a menos possível.
                    mutationTax -= 0.2;
                } else if (novosK == 0 && mutationTax < 1.0) {// Aumenta mutação caso Pk não tenha evoluido e mutação
                                                              // não seja maior que o limite máximo.
                    mutationTax += 0.2;
                }
                ...
                // System.out.println("Melhorias:" + novosK + ",M:" + mutationTax + ",C:" +
                // (1.0-mutationTax));
    ...
    public static void main(String args[]) throws FileNotFoundException {
        ...
        // Data set ***************
        // *******************************************
        String caminho = "C:\\Users\\luizn\\Documents\\ssdp_caverna\\SSDPplus\\pastas\\bases\\";
        ...
        System.out
                .println("Coverage of all Pk DPs in relation to D+: " + Avaliador.coberturaPositivo(p, k) * 100 + "%");
        System.out.println("Description Redundancy Item Dominador (|itemDominador|/k): "
                + DPinfo.descritionRedundancyDominator(p));
